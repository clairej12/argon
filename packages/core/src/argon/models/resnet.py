...
def register(registery: Registry, prefix=None):
    registery.register("SmallResNet10", SmallResNet10, prefix=prefix)
    registery.register("SmallResNet18", SmallResNet18, prefix=prefix)
    registery.register("SmallResNet50", SmallResNet50, prefix=prefix)
    registery.register("ResNet10", ResNet10, prefix=prefix)
    registery.register("ResNet18", ResNet18, prefix=prefix)
    registery.register("ResNet34", ResNet34, prefix=prefix)
    registery.register("ResNet50", ResNet50, prefix=prefix)
    registery.register("ResNet101", ResNet101, prefix=prefix)
    registery.register("ResNet152", ResNet152, prefix=prefix)
    registery.register("ResNet200", ResNet200, prefix=prefix)